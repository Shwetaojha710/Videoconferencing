...
const { createmeeting, meetinglist, checkpasscode } = require("../Controllers/vedioconfrencing/meeting");
...
router.post('/plan-subscribe',plansubscribed)
...
router.post('/check-passcode',Admin,checkpasscode)
