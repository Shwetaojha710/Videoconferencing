...
exports.checkpasscode = async (req, res) => {
  try {
    ...
    if(!meeting_link){
      return Helper.response("failed", "Meeting Link is required", [], res, 200);
    }
    const checkpasscode = await meeting.findOne({
      where: {
